...
## 3. Core values (each with its enforcing policy)

1. **More music is the whole point.** We never own the show, the door, or the audience, and we don't take a cut of anyone's pay. We stay free for as long as we can and cheap forever after — priced below the value of one filled slot — because the win condition is more live nights in more rooms, with the relationship belonging to the people in the room, not to us. *(Policy: PRD Mission, §2 non-goals, §4 mission-first business model, [`pricing.md`](pricing.md). Contrast: Sofar's promoter extraction.)*
2. **Free to be found, and free to get booked. Forever.** No performer or tech ever pays to join, apply, message, or land a gig. No pay-to-rank, no featured placement, no submission fees, no success cut. Visibility is earned by showing up and playing well. *(Policy: PRD §4.1, F1.6. Contrast: Sonicbids' fatal tollbooth, ShowSlinger's paid tiers.)*
3. **The money is on the table — and we're not on it.** Every slot shows its budget. Every party on a booking sees what every other party is paid. We never set or algorithmically adjust anyone's pay, and we never stand between an act and their money — the venue pays the act directly. *(Policy: PRD §4.6 pay transparency; anti-requirement: no algorithmic pay-setting; [`pricing.md`](pricing.md) discovery-first. Contrast: Sofar's opaque spread, GigFinesse's unpublished pricing.)*
4. **A deal is a deal.** An accepted offer is a commitment both ways — the act shows up as advertised, the venue honors the slot and the budget it posted. Reliability is tracked and reviewed in both directions: venues on showing up, listing accurately, and paying as agreed, just as acts are reviewed on showing up and playing well. When a side bails it's on their record, and the slot goes back in the feed. *(Policy: F3.2/F3.3, F7.1, reliability scoring.)*
5. **Sound is a third of the show.** Techs are bookable professionals on the same rails as everyone else — same feed, same standing, same reviews — not a line item or a favor. We're the first platform anywhere to do this. *(Policy: F6; differentiator per research §8.)*
6. **Real people, on real stages.** We screen for fake and AI-fabricated acts; we never generate or "enhance" performer media; AI drafts paperwork, humans confirm everything binding. *(Policy: anti-requirements, F7.5, K9 invariant.)*
...
- **Performers:** *More nights on stage, none of the chasing.* The venues that book acts like yours, visible at last, with budgets shown — no negotiating from zero, no essay applications, no pay-to-play. We never charge you a cent and never take a cut: the number you see is the deal, and the money goes straight from the room to you.
- **Techs:** *Finally, a market for the work.* See the gigs that need sound near you, know exactly what you're walking into — room, inputs, set times — before you commit. Booked like the band, reviewed like the band, never charged a cent — a seat at the table at last.

## 5. Voice & language

**Register: a respected stage manager.** Knows everyone, wastes nobody's time, says numbers out loud, calm when the night goes sideways. Plain-spoken and warm, never chirpy; confident, never hyped. We write like we text — most of this product *is* texts.
...
|---|---|---|
| Offer to performer | "🎉 Amazing news! A venue loved your profile!!" | "Lakefront Taproom offered you Fri Jun 26, 8–10pm, $400. Details and accept: {link}" |
| Slot confirmation (SMS) | "Your event has been successfully created!" | "Posted: Sunday brunch, acoustic, $200, 11–1. I'll text you when acts apply." |
| Venue cancels at 10 days | "Unfortunately your booking has been cancelled." | "Lakefront cancelled your Fri Jun 26 set — 10 days out, noted on their record. Want me to show you other rooms open that night?" |
| Tech brief | "You have a new opportunity!" | "Sat at Burnhearts: 4-piece, vocals through house PA, 6 inputs, bring 2 monitors. Load-in 7, sets 9–12. $250." |
| Dispute opened | "Your case is under review." | "Thanks for flagging this — a person will look and get back to you within 5 business days. Reviews stay on hold until then. Here's what we're looking at: {link}" |
...
- Never show a gig without its pay. Never publish a fee without a dollar amount.
- Never charge, rank, or feature the supply side for money.
- Never take a cut of anyone's pay, and never stand between an act and their money.
- Never use AI-generated imagery/audio of performers, anywhere, including our own marketing.
- Never claim an act "draws" without data (until the ROI loop can prove it, nobody can — including us).
- Never speak as the promoter: it's their show, their stage, their crowd. We booked the night; they made it.
