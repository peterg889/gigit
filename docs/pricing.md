...
- [ ] `docs/engineering-spec.md` / `docs/technical-design.md` / `docs/prd-coverage.md` — mark the §4 deferral list as the launch configuration; the seams they describe are correct, the defaults change.
- [ ] Code — the §4 "switched OFF" list becomes a real toggle/cleanup pass (separate task).
